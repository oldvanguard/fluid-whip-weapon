(()=>{
 ...
 const map={
  ...
  weapon:window.weaponHome||window.weaponManual,weaponcurriculum:window.weaponCurriculum,weapontrain:window.weaponTrain,weaponmove:window.weaponMove,weaponlibrary:window.weaponLibrary,
