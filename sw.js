const CACHE='fww-v4';
const ASSETS=['./','./index.html','./styles.css','./app.js','./fluid-data.js','./movement-visuals.js','./visual-engine.js','./training-engine.js','./visual-integration.js','./manifest.webmanifest'];
