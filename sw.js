const CACHE='fww-v6';
const ASSETS=['./','./index.html','./styles.css','./app.js','./fluid-data.js','./whip-data.js','./movement-visuals.js','./visual-engine.js','./training-engine.js','./visual-integration.js','./stage-integration.js','./whip-training.js','./manifest.webmanifest'];
